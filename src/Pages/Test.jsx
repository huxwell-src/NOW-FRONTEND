...
export function SidebarWithLogo() {
    ...
    return (
      <div className="lg:w-[20rem]">
        <div className={`w-full ${sidebarOpen ? "" : "hidden lg:block"} lg:hidden`}>
          <button
            onClick={toggleSidebar}
            className="absolute top-4 right-4 p-2 bg-blue-gray-100 rounded"
          >
            <ChevronRightIcon
        ...
        <div
          ...
          } transition-all overflow-hidden lg:overflow-visible lg:w-[20rem]`}
        >
